...
export declare const flipPose: (props: import("pose-core/lib/types").PoserState<Value, Action, ColdSubscription, DomPopmotionPoser>, nextPose: import("pose-core/lib/types").Pose<Action, import("popmotion-pose/src/types").TransitionDefinition>) => import("pose-core/lib/types").Pose<Action, import("popmotion-pose/src/types").TransitionDefinition>;
