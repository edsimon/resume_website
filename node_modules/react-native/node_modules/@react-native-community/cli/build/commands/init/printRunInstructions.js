...
function printRunInstructions(projectDir, projectName) {
  const relativeProjectDir = _path().default.relative(projectDir, projectName);

  const iosProjectDir = _path().default.resolve(projectDir, `${projectName}/ios`);
  ...
  const relativeXcodeProjectPath = _path().default.relative(process.cwd(), isUsingPods ? iosPodsFile : _path().default.resolve(iosProjectDir, `${projectName}.xcodeproj`));
