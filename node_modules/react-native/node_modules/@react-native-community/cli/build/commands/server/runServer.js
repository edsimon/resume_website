...
async function runServer(argv, ctx, args) {
  ...
  middlewareManager.getConnectInstance().use((0, _morgan().default)('combined', !_cliTools().logger.isVerbose() && {
  ...
  middlewareManager.attachDevToolsSocket(ms); // In Node 8, the default keep-alive for an HTTP connection is 5 seconds. In
