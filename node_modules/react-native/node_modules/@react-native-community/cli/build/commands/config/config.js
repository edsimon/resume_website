...
function isValidRNDependency(config) {
  return Object.keys(config.platforms).filter(key => Boolean(config.platforms[key])).length !== 0 || Object.keys(config.hooks).length !== 0 || config.assets.length !== 0 || config.params.length !== 0;
}
